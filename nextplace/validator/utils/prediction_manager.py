...
from nextplace.protocol import RealEstateSynapse, RealEstatePredictions
...
class PredictionManager:
    ...
    def process_predictions(self, responses: List[RealEstatePredictions]) -> None:
        ...
        with self.database_manager.lock:  # Acquire database lock so we can update the `predictions` table
